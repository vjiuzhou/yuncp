...
class Calfbb
{
    ...
    public function globalDefined($request){
        ...
        $http_type = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') || (isset($_SERVER['HTTP_X_FORWARDED_PROTO']) && $_SERVER['HTTP_X_FORWARDED_PROTO'] == 'https')   || (!empty($_SERVER['HTTPS']) && $_SERVER['HTPS'] !='off' || $_SERVER['SERVER_PORT'] == 443)) ? 'https' : 'http';
        $indexSuffix="";
