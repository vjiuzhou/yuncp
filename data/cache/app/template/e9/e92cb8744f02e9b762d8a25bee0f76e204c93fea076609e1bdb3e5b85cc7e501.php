...
/* detail/available.html */
class __TwigTemplate_8751ccd410b7e5f00f9275d70b6572ca141a0d8b4bf2ba82c82db1cce4770bb5 extends Twig_Template
{
...
<div class=\"layui-container \"  >
    ...
    <div class=\"layui-row mab-backgroud-color\">
        ...
        echo "  %</span>
            ...
            <div class=\"layui-row layui-col-md12 \" style=\"text-align: center;margin-bottom: 10px;\">   平均可用率";
        // line 57
        ...
        if (($this->getAttribute(($context["_GPC"] ?? null), "orderby", array(), "array") == "asc")) {
            ...
            echo "-desc.html\" class=\"layui-btn layui-btn-ceping\" data-type=\"parseTable\">切换最高</a>
            ...
            echo "-";
            echo twig_escape_filter($this->env, $this->getAttribute(($context["_GPC"] ?? null), "type", array(), "array"), "html", null, true);
            echo "-asc.html\" class=\"layui-btn layui-btn-ceping\" data-type=\"parseTable\">切换最低</a>
                ";
        }
        // line 65
        echo "            </div>
        ...
        $context['_seq'] = twig_ensure_traversable(($context["availableTop10"] ?? null));
        ...
        // line 103
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["availableOperator"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["data"]) {
            // line 104
            echo "            <div class=\"layui-row  ceping-bottom\">
                <div class=\"layui-col-md4\" >
...
//        return Math.round(Math.random()*500);
    ...
    var url=\"";
        // line 653
        echo twig_escape_filter($this->env, $this->getAttribute(($context["G"] ?? null), "url", array(0 => "app/CePingDetail/getMapDataAvailable", 1 => array("id" => $this->getAttribute(($context["_GPC"] ?? null), "id", array(), "array"), "type" => $this->getAttribute(($context["_GPC"] ?? null), "type", array(), "array"))), "method"), "html", null, true);
        echo "\";
    mapdata = [
...
{{ include(\"common/ceping_footer.html\")}}", "detail/available.html", "/data/test/yunceping/bbs/app/template/detail/available.html");
    }
}
