...
/* login/login.html */
class __TwigTemplate_e9f7315562f39af67a442369fa43e3a3c935bab1ed575c2596e6bf281dd322ff extends Twig_Template
{
...
<script>
    ...
    function login(){
        ...
        \$.ajax({
            url:\"";
        // line 125
        echo twig_escape_filter($this->env, $this->getAttribute(($context["G"] ?? null), "url", array(0 => "admin/login/login"), "method"), "html", null, true);
        echo "\",//当前ajax请求的地址
            type:'post',//请求的方式
...
", "login/login.html", "/data/test/yunceping/bbs/addons/admin/template/login/login.html");
    }
}
