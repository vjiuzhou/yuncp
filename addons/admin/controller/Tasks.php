...
{
    const ADMIN_POSTS_LIST = 'admin/tasks/taskslist';
    ...
    public function Taskslist(){
        ...
        $param['sort']="DESC";
        $data       = $this->post(url("api/Tasks/getPostListByAdmin"), $param);
        $list       = "";
        $pagination = "";
    ...
    public function add()
    {
        ...
        $data = $this->get(url("api/Tasks/getPost", "id=" . $_GET['id']));
    ...
    public function delete()
    {
        ...
        if (empty($_POST)) {
            ...
            $data = $this->post(url("api/tasks/delPost"), ['id' => $_GET['id'], 'uid' => @self::$userinfo['uid']]);
        } else {
            ...
            foreach ($_POST['deletes'] as $id) {
                ...
                $data = $this->post(url("api/tasks/delPost"), ['id' => $id, 'uid' => @self::$userinfo['uid']]);
    ...
    public function Articledisplay()
    {
        ...
        $data = $this->post(url("api/tasks/delPost"), ['id' => $_GET['id'], 'uid' => @self::$userinfo['uid'],'status'=>1]);
