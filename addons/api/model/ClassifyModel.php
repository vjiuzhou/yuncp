...
class ClassifyModel extends BaseModel
{
    ...
    public function selectClassify($data){
        $result=db_select(self::$tableName,$fields = "*",$where = [],$data['current_page'], $data['page_size'],$orderby=['orders' =>'ASC']);
        return $result;
    }
    ...
    public function getClassify(){
        $result = db_select(self::$tableName,$fields = '*',$where=[],$page='',$pagesize='',$orderby=['orders'=>"ASC"]);
        return $result;
    }
